...
Add at most one pairing or weight parameter when it represents a real system choice. (Live mode's parameter contract does not apply — live mode is not vendored in this project.)
