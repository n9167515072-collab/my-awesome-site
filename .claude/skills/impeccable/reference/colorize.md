...
Add at most two variant-specific parameters, such as palette, temperature, or tint behavior. (Live mode's parameter contract does not apply — live mode is not vendored in this project.)
