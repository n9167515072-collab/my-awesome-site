...
Add one structural parameter only when the topology genuinely branches. (Live mode's parameter contract does not apply — live mode is not vendored in this project.)
